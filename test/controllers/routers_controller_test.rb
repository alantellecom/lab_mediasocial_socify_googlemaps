...
class RoutersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create router" do
    assert_difference('Router.count') do
      post routers_url, params: { router: { latitude: @router.latitude, longitude: @router.longitude } }
    end
  ...
  test "should update router" do
    patch router_url(@router), params: { router: { latitude: @router.latitude, longitude: @router.longitude } }
